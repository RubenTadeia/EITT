...
if (file_exists($target_file)) {
    echo "Sorry, file already exists. Change the name of the Image and upload again!";
    $uploadOk = 0;
}
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file) OR $aux==1) {
        ...
        $sql->execute(array($serial_number, $name, $imageName));
